...
app.get('/api/platform/plans',requireAuth,requireSuperAdmin,(req,res)=>res.json({plans:[
  ...
  {id:'pro',name:'Pro',price:49900,userLimit:50,features:['Tudo do Business','Até 50 usuários','Suporte prioritário']}
]}));
