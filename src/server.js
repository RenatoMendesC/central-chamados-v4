    ...
    try {
      ...
      if (org.mp_subscription_id) {
        ...
        for (const mapping of mappings) {
          ...
          const candidate =
            subscriptions.find(x => x?.id && x?.status === 'authorized') ||
            subscriptions.find(x => x?.id);
