...
/* --------------------------------------------
   FALLBACK DE SINCRONIZAÃ‡ÃƒO APÃ“S CHECKOUT
   -------------------------------------------- */
...
console.log('[BILLING SYNC] org=' + organizationId + ' planos=' + JSON.stringify(mappings));
      ...
      for (const mapping of mappings) {
        ...
        console.log(
          `[BILLING] SincronizaÃ§Ã£o concluÃ­da: org=${organizationId} subscription=${candidate.id} status=${org?.billing_status || 'unknown'}`
        );
